                    ...
                    <div className="header__menu">
                        <ul className="header__nav">
                            <li className="header__nav-item">
                                <Link to="/"><div id={"home"} className="header__nav-link">Home</div></Link>
                            </li>
                            <li className="header__nav-item">
                                <Link to="/explorer"><div id={"explorer"} className="header__nav-link">Explorer</div></Link>
                            </li>
                            <li className="header__nav-item">
                                <Link to="/blog"><div id={"blog"} className="header__nav-link" >News</div></Link>
                            </li>
