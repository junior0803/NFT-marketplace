                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        <div className="sign__file">
                                            <label id="file1" htmlFor="sign__file-upload">e. g. Image, Audio,
                                                Video</label>
                                    ...
                                    <div className="col-12">
                                        <div className="sign__group">
                                            ...
                                            <input id="itemname" type="text" name="itemname" className="sign__input"
                                    ...
                                    <div className="col-12">
                                        <div className="sign__group">
                                            ...
                                            <textarea id="description" name="description" className="sign__textarea"
                                                      placeholder="e. g. 'After purchasing you will able to recived...'"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-12 col-md-4">
                                        <div className="sign__group">
                                            ...
                                            <input id="size" type="text" name="size" className="sign__input"
                                    ...
                                    <div className="col-12 col-md-4">
                                        <div className="sign__group">
                                            ...
                                            <input id="propertie" type="text" name="propertie" className="sign__input"
                                                   placeholder="Subject" />
                                        </div>
                                    </div>
