                    ...
                    <div className="col-12 col-lg-7 col-xl-8">
                        <form action="#" className="sign__form sign__form--contacts">
                            <div className="row">
                                ...
                                <div className="col-12">
                                    <div className="sign__group">
                                        <textarea name="text" className="sign__textarea"
                    ...
                    <div className="col-12 col-md-6 col-lg-5 col-xl-4">
                        ...
                        <ul className="contacts__list">
                            ...
                            <li><a
                                ...
                                className="open-map">221B Baker St, Marylebone, London</a></li>
                        </ul>
                        <div className="contacts__social">
                            <a href="#" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M20.9,2H3.1A1.1,1.1,0,0,0,2,3.1V20.9A1.1,1.1,0,0,0,3.1,22h9.58V14.25h-2.6v-3h2.6V9a3.64,3.64,0,0,1,3.88-4,20.26,20.26,0,0,1,2.33.12v2.7H17.3c-1.26,0-1.5.6-1.5,1.47v1.93h3l-.39,3H15.8V22h5.1A1.1,1.1,0,0,0,22,20.9V3.1A1.1,1.1,0,0,0,20.9,2Z"></path>
                                </svg>
                            </a>
                            ...
                            <a href="mailto:support@Unitok.com">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                        ...
                        <div className="partners owl-carousel owl-loaded">
                            ...
                            <div className="owl-stage-outer">
                                <div className="owl-stage"
                                     style={{
                                         transform: "translate3d(-1662px, 0px, 0px)",
                                         transition: "all 0.6s ease 0s",
                                         width: 3658
                                     }}>
                                    <div className="owl-item cloned" style={{width: 136.25, marginRight: 30}}><a
                                        href="#" className="partners__img">
                                    ...
                                    <div className="owl-item cloned" style={{width: 136.25, marginRight: 30}}>
                                    ...
                                    <div className="owl-item" style={{width: 136.25, marginRight: 30}}>
                                        <a href="#" className="partners__img">
                                            <img src="img/partners/3docean-light-background.png" alt=""/>
                                        </a></div>
                                    <div className="owl-item" style={{width: 136.25, marginRight: 30}}>
                                    ...
                                    <div className="owl-item active" style={{width: 136.25, marginRight: 30}}>
                                        <a href="#" className="partners__img">
                                            <img src="img/partners/audiojungle-light-background.png" alt=""/>
                                        </a></div>
                                    <div className="owl-item active" style={{width: 136.25, marginRight: 30}}>
                                    ...
                                    <div className="owl-item cloned active" style={{width: 136.25, marginRight: 30}}>
                                        <a href="#" className="partners__img">
                                            <img src="img/partners/3docean-light-background.png" alt=""/>
                                        </a></div>
                                    <div className="owl-item cloned active" style={{width: 136.25, marginRight: 30}}>
