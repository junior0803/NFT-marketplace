...
import Explorers from "../home/explorers";
                ...
                <div className="row row--grid">
                    ...
                    <div className="col-12">
                        <div className="main__title main__title--page">
                            <h1>Exclusive NFT Events and Concert</h1>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12 col-xl-8">
                        <div className="asset__item">
                            <a className="asset__img" href="img/cover/cover-big.jpg"><img src="img/cover/cover-big.jpg" alt=""/></a>
                    ...
                    <div className="col-12 col-xl-4">
                        ...
                        <div className="asset__btns">
                            <Link to="#modal-bid" className="asset__btn asset__btn--full asset__btn--clr open-modal">Buy Ticket</Link>
                        </div>
                ...
                <section className="row row--grid">
                    ...
                    <div className="col-12">
                        <div className="main__carousel-wrap">
                            <div className=" main__carousel--live owl-carousel" id="explore">
                                <div className="card" style={{width: 302.5, marginRight: 30}}>
                                ...
                                <div className="card" style={{width: 302.5, marginRight: 30}}>
                                    ...
                                    <h3 className="card__title">
                                        <Link to="/item">Flowers in Concrete</Link></h3>
                                    <div className="card__author">
                                        <img src="img/avatars/avatar5.jpg" alt=""/>
                                        <Link to="/author">@midinh</Link>
                                    </div>
