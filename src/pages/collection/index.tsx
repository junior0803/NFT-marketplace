                    ...
                    <div className="col-12 col-xl-3">
                        <div className="author author--page">
                            <div className="author__meta">
                                ...
                                <p className="author__text">All the Lorem Ipsum generators on the Internet tend to repeat
                                    ...
                                    <div className="owl-stage"
                                        ...
                                        <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                            <div className="collection" style={{width: 200, marginLeft: 20}}>
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small3.png"
                                                   style={{background: "img/bg/bg-small3.png", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}/>
                                        ...
                                        <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                            <div className="collection">
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small4.png"
                                                   style={{background: "img/bg/bg-small4.png", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}/>
                                                <div className="collection__meta">
                                        ...
                                        <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                            <div className="collection" style={{width: 200, marginLeft: 20}}>
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small5.png"
                                                   style={{background: "img/bg/bg-small5.png", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}/>
                                                <div className="collection__meta">
                                                    <Link to="/author.html"
                                                       className="collection__avatar collection__avatar--verified">
                                        ...
                                        <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                            <div className="collection" style={{width: 200, marginLeft: 20}}>
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small6.png"
                                                   style={{background: 'img/bg/bg-small6.png', backgroundRepeat: "no-repeat", backgroundPosition: "center"}}/>
                                                <div className="collection__meta">
                                                    <Link to="/author" className="collection__avatar">
                                        ...
                                        <div className="owl-item active" style={{width: 236, marginRight: 30}}>
                                            <div className="collection" style={{width: 200, marginLeft: 20}}>
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small.png"
                                                   style={{background: "img/bg/bg-small.png", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}/>
                                                <div className="collection__meta">
                                        ...
                                        <div className="owl-item active" style={{width: 236, marginRight: 30}}>
                                            <div className="collection" style={{width: 200, marginLeft: 20}}>
                                                <Link to="/collection" className="collection__cover" data-bg="img/bg/bg-small2.png"
