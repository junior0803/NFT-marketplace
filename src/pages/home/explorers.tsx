                                ...
                                <div className="owl-stage"
                                    ...
                                    <div className="owl-item" style={{width: 302.5, marginRight: 30}}>
                                        <div className="card">
                                            ...
                                            <h3 className="card__title"><a href="item.html">Les Immortels, the
                                                Treachery of Artificial Shadows</a></h3>
                                            <div className="card__author ">
                                                <div className="text__location">
                                                    <span>Date 23/11/2021</span>
                                                    <div>
