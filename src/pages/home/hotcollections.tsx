                            ...
                            <div className="owl-stage"
                                ...
                                <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           data-bg="img/bg/bg-small3.png"
                                           style={{background: "img/bg/bg-small3.png"}}></a>
                                        <div className="collection__meta">
                                            ...
                                            <h3 className="collection__name"><a
                                                href="collection.html">Inventory</a></h3>
                                ...
                                <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           ...
                                           style={{background: "img/bg/bg-small4.png", backgroundRepeat: "no-repeat",backgroundPosition: "center"}} ></a>
                                        <div className="collection__meta">
                                            <a href="author.html" className="collection__avatar">
                                                <img src="img/avatars/avatar15.jpg" alt="" />
                                            </a>
                                            <h3 className="collection__name"><a
                                                href="collection.html">ProphecyNFT</a></h3>
                                ...
                                <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           ...
                                           style={{background: "img/bg/bg-small5.png", backgroundRepeat: "no-repeat",backgroundPosition: "center"}} ></a>
                                        <div className="collection__meta">
                                            <a href="author.html"
                                               className="collection__avatar collection__avatar--verified">
                                            ...
                                            <h3 className="collection__name"><a
                                                href="collection.html">Hashavatars</a></h3>
                                            <span className="collection__number">ERC-1155</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           ...
                                           style={{background: "img/bg/bg-small6.png", backgroundRepeat: "no-repeat",backgroundPosition: "center"}} ></a>
                                        <div className="collection__meta">
                                            <a href="author.html" className="collection__avatar">
                                                <img src="img/avatars/avatar11.jpg" alt="" />
                                            </a>
                                            <h3 className="collection__name"><a href="collection.html">Clap
                                                Token</a></h3>
                                            <span className="collection__number">ERC-1155</span>
                                        </div>
                                    </div>
                                ...
                                <div className="owl-item cloned" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"></a>
                                        <div className="collection__meta">
                                            <a href="author.html"
                                               className="collection__avatar collection__avatar--verified">
                                                <img src="img/avatars/avatar15.jpg" alt="" />
                                            ...
                                            <h3 className="collection__name"><a
                                                href="collection.html">InventoryNFT</a></h3>
                                            <span className="collection__number">ERC-721</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="owl-item active" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        ...
                                        <div className="collection__meta">
                                            ...
                                            <h3 className="collection__name"><a
                                                href="collection.html">Hashmasks</a></h3>
                                            <span className="collection__number">ERC-721</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="owl-item active" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           ...
                                           style={{background: "img/bg/bg-small2.png", backgroundRepeat: "no-repeat",backgroundPosition: "center"}} ></a>
                                        <div className="collection__meta">
                                            <a href="author.html"
                                               className="collection__avatar collection__avatar--verified">
                                            ...
                                            <h3 className="collection__name"><a
                                                href="collection.html">NFTheft</a></h3>
                                            <span className="collection__number">ERC-721</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="owl-item active" style={{width: 236, marginRight: 30}}>
                                    <div className="collection">
                                        <a href="collection.html" className="collection__cover"
                                           data-bg="img/bg/bg-small3.png"
                                           style={{background: "img/bg/bg-small3.png", backgroundRepeat: "no-repeat",backgroundPosition: "center"}} ></a>
                                        <div className="collection__meta">
                                            <a href="author.html"
                                               className="collection__avatar collection__avatar--verified">
                                                <img src="img/avatars/avatar12.jpg" alt="" />
