        ...
        return(
            <div className="col-12">
                <div className="main__title">
                    <h2><Link to="/explorer">Latest Events</Link></h2>
                </div>
            </div>
        );
    }
                                ...
                                <div className="owl-stage" style={{
                                    ...
                                    <div className="owl-item cloned" style={{width: 302.5, marginRight: 30}}>
                                        <div className="card">
                                            ...
                                            <h3 className="card__title">
                                                <Link to="/item" className="open-modal">Tranquility (Modal)</Link>
                                            </h3>
                                            <div className="card__author ">
                                                <div className="text__location">
                                                    <span>Date 23/11/2021</span>
                                    ...
                                    <div className="owl-item" style={{width: 302.5, marginRight: 30}}>
                                        <div className="card">
                                            ...
                                            <h3 className="card__title">
                                                <a href="#modal-asset" className="open-modal">Flowers in Concrete (Modal)</a></h3>
                                            <div className="card__author ">
                                                <div className="text__location">
                                                    <span>Date 23/11/2021</span>
                                                    <div>
                                    ...
                                    <div className="owl-item active" style={{width: 302.5, marginRight: 30}}>
                                        <div className="card">
                                            ...
                                            <h3 className="card__title">
                                                <a href="#modal-asset" className="open-modal">Tranquility (Modal)</a>
                                            </h3>
                                            <div className="card__author ">
                                                <div className="text__location">
                                                    <span>Date 23/11/2021</span>
