            ...
            <div className="row">
               <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                    ...
                    <p className="footer__tagline">
                            Digital marketplace for crypto collectibles <br />and non-fungible
                            tokens (NFTs). <br />Buy, sell, and discover exclusive digital assets.
                    </p>
               ...
               <div
                        className="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="footer__content">
                            ...
                            <small className="footer__copyright">© Backstage, 2021. Created by <a
                                href="https://www.Chainplug.io" target="_blank">Chainplug</a>.</small>
                        </div>
                    </div>
                </div>
            </div>
