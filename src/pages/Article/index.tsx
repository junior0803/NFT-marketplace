                            ...
                            <div className="article__content">
                                <img src="img/posts/article.jpg" alt="" />
                                    ...
                                    <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as
                                        their default model text, and a search for 'lorem ipsum' will <b>uncover
                                            many</b> web sites still in their infancy. Various versions have evolved
                                    ...
                                    <blockquote>If you are going to use a passage of Lorem Ipsum, you need to be sure
                                    ...
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                        ...
                                        which don't look even slightly believable. If you are going to use a passage of
                                        Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the
                                        middle of text. <a href="#">Link</a> the Lorem Ipsum generators on the Internet
                            ...
                            <div className="comments">
                                ...
                                <ul className="comments__list">
                                    ...
                                    <li className="comments__item comments__item--answer">
                                        ...
                                        <p className="comments__text">Lorem Ipsum is simply dummy text of the printing
