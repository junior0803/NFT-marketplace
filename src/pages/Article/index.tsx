            ...
            <div className="row row--grid">
                <div className="col-12 col-xl-10 offset-xl-1">
                    <ul className="breadcrumb">
                        ...
                        <li className="breadcrumb__item"><a href="blog.html">Blog</a></li>
                        ...
                        <div className="article__content">
                            <img src="img/posts/article.jpg" alt="" />
                                ...
                                <div className="article__meta">
                                    ...
                                    <span className="article__date"><svg xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 24 24"><path
                                        d="M12,2A10,10,0,1,0,22,12,10.01114,10.01114,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,12,20ZM14.09814,9.63379,13,10.26807V7a1,1,0,0,0-2,0v5a1.00025,1.00025,0,0,0,1.5.86621l2.59814-1.5a1.00016,1.00016,0,1,0-1-1.73242Z"></path></svg> 09.03.2021, 16:37</span>
                                </div>
                                ...
                                <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                                    default model text, and a search for 'lorem ipsum' will <b>uncover many</b> web
                                ...
                                <blockquote>If you are going to use a passage of Lorem Ipsum, you need to be sure there
                                ...
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    ...
                                    don't look even slightly believable. If you are going to use a passage of Lorem
                                    Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of
                                    text. <a href="#">Link</a> the Lorem Ipsum generators on the Internet tend to repeat
                        ...
                        <div className="comments">
                            ...
                            <ul className="comments__list">
                                <li className="comments__item">
                                    ...
                                    <p className="comments__text">There are many variations of passages of Lorem Ipsum
                                    ...
                                    <div className="comments__actions">
                                        <div className="comments__rate">
                                            <button type="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path
                                                        d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H13V8a1,1,0,0,0-2,0v3H8a1,1,0,0,0,0,2h3v3a1,1,0,0,0,2,0V13h3a1,1,0,0,0,0-2Z"></path>
                                                </svg>
                                                12
                                            </button>

                                            <button type="button">7 <svg xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z"></path>
                                            </svg></button>
                                        </div>
                                        ...
                                        <button type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path
                                                    d="M21.707,11.293l-8-8A.99991.99991,0,0,0,12,4V7.54492A11.01525,11.01525,0,0,0,2,18.5V20a1,1,0,0,0,1.78418.62061,11.45625,11.45625,0,0,1,7.88672-4.04932c.0498-.00635.1748-.01611.3291-.02588V20a.99991.99991,0,0,0,1.707.707l8-8A.99962.99962,0,0,0,21.707,11.293ZM14,17.58594V15.5a.99974.99974,0,0,0-1-1c-.25488,0-1.2959.04932-1.56152.085A14.00507,14.00507,0,0,0,4.05176,17.5332,9.01266,9.01266,0,0,1,13,9.5a.99974.99974,0,0,0,1-1V6.41406L19.58594,12Z"></path>
                                            </svg>
                                            <span>Reply</span></button>
                                        <button type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path
                                                    d="M19,14a1,1,0,0,0-1.22.72A7,7,0,0,1,11,20H5.41l.64-.63a1,1,0,0,0,0-1.41A7,7,0,0,1,9.25,6.22a1,1,0,0,0-.5-1.94A9,9,0,0,0,4,18.62L2.29,20.29a1,1,0,0,0-.21,1.09A1,1,0,0,0,3,22h8a9,9,0,0,0,8.72-6.75A1,1,0,0,0,19,14ZM21,2a1,1,0,0,0-1,1h0a5,5,0,1,0,.3,7.75A1,1,0,1,0,19,9.25,3,3,0,1,1,17,4a3,3,0,0,1,2.23,1H18a1,1,0,0,0,0,2h3a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2Z"></path>
                                            </svg>
                                ...
                                <li className="comments__item comments__item--answer">
                                    ...
                                    <p className="comments__text">Lorem Ipsum is simply dummy text of the printing and
                                    ...
                                    <div className="comments__actions">
                                        <div className="comments__rate">
                                            ...
                                            <button type="button">0 <svg xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z"></path>
                                            </svg></button>
                                ...
                                <li className="comments__item comments__item--quote">
                                    ...
                                    <p className="comments__text"><span>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</span>It
                                    ...
                                    <div className="comments__actions">
                                        <div className="comments__rate">
                                            ...
                                            <button type="button">2 <svg xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z"></path>
                                            </svg></button>
                                ...
                                <li className="comments__item">
                                    ...
                                    <div className="comments__actions">
                                        <div className="comments__rate">
                                            ...
                                            <button type="button">4 <svg xmlns="http://www.w3.org/2000/svg"
                                                                         viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z"></path>
                                            </svg></button>
                                ...
                                <li className="comments__item">
                                    ...
                                    <p className="comments__text">Many desktop publishing packages and web page editors
                                    ...
                                    <div className="comments__actions">
                                        <div className="comments__rate">
                                            ...
                                            <button type="button">17 <svg xmlns="http://www.w3.org/2000/svg"
                                                                          viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z"></path>
                                            </svg></button>
                            ...
                            <form action="#" className="comments__form">
                                <div className="sign__group">
                                    <textarea id="text" name="text" className="sign__textarea"
