        ...
        return (
            <div className="container" style={{marginTop: 70, marginBottom: 70}}>
                    ...
                    <div className="col-12">
                        <div className="main__filter" style={{width: 1258, marginLeft:20}}>
                            ...
                            <div className="main__filter-wrap">
                                <select className="main__select select2-hidden-accessible" name="status"
                                ...
                                <select className="main__select select2-hidden-accessible" name="category"
                                    ...
                                    <option value="7">Memes</option>
                                               ...
                                               dir="ltr"
                                               data-select2-id="5" style={{width: 102}}><span
                                className="selection"><span
                                className="select2-selection select2-selection--single" role="combobox"
                                aria-haspopup="true"
                                aria-expanded="false" aria-disabled="false"
                                aria-labelledby="select2-category-k6-container">
                                <span
                                    className="select2-selection__rendered" id="select2-category-k6-container"
                                    role="textbox"
                                    aria-readonly="true" title="All categories">All categories</span>
                                <span className="select2-selection__arrow" role="presentation">
                                <b role="presentation"/></span></span></span>
                                <span className="dropdown-wrapper" aria-hidden="true"/></span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row row--grid">
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                        <div className="card" style={{height: 460, width: 260, marginLeft :20}}>
                            <div className="card__cover card__cover--carousel owl-carousel owl-loaded owl-drag">
                                <div className="owl-stage-outer">
                                    <div className="owl-stage"
                                         style={{
                                             transform: 'translate3d(-561px, 0px, 0px)',
                                             transition: 'all 0.8s ease 0s',
                                             width: 1964
                                         }}>
                                        <div className="owl-item cloned" style={{width: 260.5, marginRight: 20}}>
                                            <img
                                                src="img/cover/slide2.jpg" alt=""/></div>
                                        <div className="owl-item cloned" style={{width: 260.5, marginRight: 20}}><img
                                            src="img/cover/slide3.jpg" alt=""/></div>
                                        <div className="owl-item active" style={{width: 260.5, marginRight: 20}}><img
                                            src="img/cover/slide1.jpg" alt=""/></div>
                                        <div className="owl-item" style={{width: 260.5, marginRight: 20}}><img
                                            src="img/cover/slide2.jpg" alt=""/></div>
                                        <div className="owl-item" style={{width: 260.5, marginRight: 20}}><img
                                            src="img/cover/slide3.jpg" alt=""/></div>
                                        <div className="owl-item cloned" style={{width: 260.5, marginRight: 20}}><img
                            ...
                            <h3 className="card__title">
                                <Link to ="/item">To Infinity And Beyond</Link>
                            </h3>
                        ...
                        <div className="card" style={{height: 460, width: 260, marginLeft :20}}>
                            <Link to ="/item" className="card__cover">
                                ...
                                <span className="card__time card__time--clock">
                                    ...
                                    <span className="card__clock card__clock--2">18:42:50</span>
                                </span>
                            </Link>
                            <h3 className="card__title">
                                <Link to ="/item">Les Immortels, the Treachery of Artificial
                                    Shadows</Link>
                            </h3>
                            <div className="card__author card__author--verified">
